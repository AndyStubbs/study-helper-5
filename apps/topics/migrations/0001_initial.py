    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_chunk', models.ForeignKey(blank=True, help_text='The chunk that serves as the source for the question.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questions', to='topics.chunk')),
            ],
        ),
        migrations.CreateModel(
            name='Explanation',
